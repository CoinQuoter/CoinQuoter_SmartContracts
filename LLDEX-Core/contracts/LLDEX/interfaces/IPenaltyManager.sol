...
interface IPenaltyManager {
     ...
     * @param sender address of account withdrawing token
     ...
     * @param from address of account transfering balance to @to
     * @param to address of account receiving balance
     ...
     * @param receiver address of account that received penalty
     ...
     * @param addr address of account to check balance of
     ...
     * @param to address of account that will receive ownership
