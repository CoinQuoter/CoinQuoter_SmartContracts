...
import { BlueCard, YellowCard } from 'components/Card'
...
`
const FallbackWrapper = styled(BlueCard)`
  ${BaseWrapper}
  width: auto;
  border-radius: 12px;
  padding: 8px 12px;
...
export default function SessionCard() {
  ...
  return <FallbackWrapper title={info.label}>Session: Inactive</FallbackWrapper>
}
