...
Hacketon side note: Design of LLDEX allows for a very good integration with Hummingbot, but due to limited resources we just to finish on a core leaving integration for a latter stages.
