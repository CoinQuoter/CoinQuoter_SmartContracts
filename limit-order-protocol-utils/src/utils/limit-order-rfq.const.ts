...
export const createOrderSchema: PromptObject[] = [
    ...
    },
    {
        type: 'text',
        name: 'makerAddress',
        message: 'Maker address (optional)',
    },
];
...
export const fillOrderSchema: PromptObject[] = [
    ...
    },
    {
        ...
        name: 'takerAmount',
        message:
            'Taker asset fill amount (set 0 if you will use maker asset amount)',
    },
    {
        type: 'text',
        name: 'makerAmount',
        message: 'Maker asset amount (set 0 if has set taker asset amount)',
    },
];
