...
interface IPenaltyManager {
    /**
     * @notice Emitted on successful deposit of Quoter token
    ...
    /**
     * @notice Emitted on successful withdrawn of Quoter token
    ...
    /**
     * @notice Deposits Quoter token to penalty manager
    ...
    /**
     * @notice Withdraws Quoter token from penalty manager to msg.sender
    ...
    /**
     * @notice Withdraws Quoter token from penalty manager to @to
     * @param amount amount of tokens to withdraw
     * @return balance after withdrawing the tokens
     */
    ...
    /**
     * @notice Returns balance of Quoter token available for use as penalty
